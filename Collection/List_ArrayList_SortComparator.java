...
class DescendingSorter implements Comparator<Cricketer> {
	...
	// 1 if cricketer1 > cricketer2  // 0 if cricketer1 = cricketer2
	//Since we want to sort in descending order	//we should return -1 when runs are more
	@Override
...
public class List_ArrayList_SortComparator {
